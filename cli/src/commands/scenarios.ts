...
// 2. `--validate <path>`: one-tick-boot harness for fixture scenarios
...
export function createScenariosCommand(
  ...
  const command = new Command("scenarios")
    .description(
      "List built-in scenario presets; with --validate, boot-test a fixture scenario directory generated by riptide-config"
    )
    .option(
      "--validate <path>",
