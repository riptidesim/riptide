...
fn validate(adapter: &Adapter, path: &str) -> Result<(), AdapterError> {
    // Phase 6 review fix (2026-04-13): reject identifiers that could
    // inject control sequences into operator-visible output. Adapter
...
"#;
    ...
    // Phase 6 review fix (2026-04-13): untrusted adapter identifiers
    // must not be able to smuggle control characters into the
