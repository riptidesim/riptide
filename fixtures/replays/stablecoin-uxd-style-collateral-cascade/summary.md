...
- **Outcome:** 11 invariant firing(s) across 3 declared invariant(s); `no_hedge_loss_during_healthy_run` first fired at tick 3 · terminal pool.cumulative_hedge_loss_bps=4000.0
