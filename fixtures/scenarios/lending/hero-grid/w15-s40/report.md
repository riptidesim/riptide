...
- **Output**: `fixtures/scenarios/lending/hero-grid/w15-s40`
...
```sh
riptide run .riptide/scenarios/lending/hero-grid/w15-s40/run-config.json --adapter /home/ailton/Work/riptide/riptide/fixtures/adapters/lending.toml
```
