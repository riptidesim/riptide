...
- **Output**: `fixtures/scenarios/lending/whale-share-sweep`
...
```sh
riptide run .riptide/scenarios/lending/whale-share-sweep/run-config.json --adapter /home/ailton/Work/riptide/riptide/fixtures/adapters/lending.toml
```
