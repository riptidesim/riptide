...
- **Seed**: 2904001
- **Ticks**: 32
- **Agents**: 24 (6× Steady staker, 6× Yield maximizer, 8× Panic exiter, 4× Arb redeemer)
- **Scenario**: baseline
- **Output**: `fixtures/scenarios/liquid-staking/slash-redemption-cascade`
...
| pool.exchange_rate_bps_avg | 9696.9697 |
| pool.exchange_rate_bps_max | 10000 |
| pool.exchange_rate_bps_min | 0 |
| pool.lst_supply_avg | 192 |
| pool.lst_supply_max | 384 |
...
| pool.total_assets_avg | 192 |
| pool.total_assets_max | 384 |
...
| stake_account.lst_balance_avg | 8 |
| stake_account.lst_balance_max | 16 |
...
```sh
riptide run fixtures/scenarios/liquid-staking/slash-redemption-cascade/run-config.json
```
