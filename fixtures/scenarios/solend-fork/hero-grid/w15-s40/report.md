...
- **Output**: `fixtures/scenarios/solend-fork/hero-grid/w15-s40`
...
```sh
riptide run .riptide/scenarios/solend-fork/hero-grid/w15-s40/run-config.json --adapter /home/ailton/Work/riptide/riptide/fixtures/adapters/solend-fork.toml
```
