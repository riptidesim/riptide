...
- **Output**: `fixtures/scenarios/solend-fork/hero-grid/w25-s20`
...
```sh
riptide run .riptide/scenarios/solend-fork/hero-grid/w25-s20/run-config.json --adapter /home/ailton/Work/riptide/riptide/fixtures/adapters/solend-fork.toml
```
