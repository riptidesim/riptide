...
- **Output**: `fixtures/scenarios/solend-fork/oracle-lag-baseline`
...
- T5: Steady LP (agent-002) — liquidate → failed
...
```sh
riptide run .riptide/scenarios/solend-fork/oracle-lag-baseline/run-config.json --adapter /home/ailton/Work/riptide/riptide/fixtures/adapters/solend-fork.toml
```
