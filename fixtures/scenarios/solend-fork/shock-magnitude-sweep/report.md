...
- **Output**: `fixtures/scenarios/solend-fork/shock-magnitude-sweep`
...
```sh
riptide run .riptide/scenarios/solend-fork/shock-magnitude-sweep/run-config.json --adapter /home/ailton/Work/riptide/riptide/fixtures/adapters/solend-fork.toml
```
