...
- **Scenario**: baseline
- **Output**: `fixtures/scenarios/solend-fork/utilization-climb`
...
```sh
riptide run .riptide/scenarios/solend-fork/utilization-climb/run-config.json --adapter /home/ailton/Work/riptide/riptide/fixtures/adapters/solend-fork.toml
```
