...
- **Output**: `fixtures/scenarios/solend-fork/whale-share-sweep`
...
```sh
riptide run .riptide/scenarios/solend-fork/whale-share-sweep/run-config.json --adapter /home/ailton/Work/riptide/riptide/fixtures/adapters/solend-fork.toml
```
