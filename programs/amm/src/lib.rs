...
//!
//! ships the third protocol-class target for the 6-layer
//! stack growth rhythm after lending_pool and perpetuals
//!. **AMM-lite** scope: 4 instructions (initialize_pool,
...
//! moving real tokens, matching how lending_pool and perpetuals
...
//! the taxonomy targets: price manipulation via swap,
