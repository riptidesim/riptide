//! `stablecoin` instruction processor.
//!
//! Mirrors the shape of perpetuals / amm / liquid-staking:
...
impl Processor {
        ...
        match instruction {
            ...
            StablecoinInstructionData::RequestRedeem { stable_amount } => {
                ...
                if pool_state.reserve_buffer_assets >= assets_owed {
                    ...
                    // pool level (same discipline liquid-staking
    ...
    /// same shape. Same pattern liquid-staking uses.
