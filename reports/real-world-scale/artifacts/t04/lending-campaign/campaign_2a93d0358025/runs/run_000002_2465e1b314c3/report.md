...
- **Output**: `/home/ailton/Work/riptide/riptide/reports/real-world-scale/artifacts/t04/lending-campaign/campaign_2a93d0358025/runs/run_000002_2465e1b314c3`
...
```sh
exec riptide run reports/real-world-scale/artifacts/t04/lending-campaign/campaign_2a93d0358025/runs/run_000002_2465e1b314c3/run-config.json --adapter fixtures/adapters/lending.toml
```
