# Run summary — `price-shock`

> Simulation evidence — not audit signoff.

- **Adapter:** `fixtures/adapters/lending.toml`
- **Scenario:** `simulation-run` · `price-shock` · ticks=20 · agents=20
- **Canonical hash:** `80fb1370f4099e7fb96bf267d3d9ca86c38dda5f14ea79fc781dcb650fe14dbc`
- **Outcome:** 3 invariant firing(s) across 3 declared invariant(s); `collection_worst_health_factor` first fired at tick 8
- **Invariants:** 3 declared · 3 firing(s) — `collection_worst_health_factor`×3 (tick 8)
