...
- **Output**: `fixtures/scenarios/lending/hero-grid/w5-s30`
...
```sh
riptide run .riptide/scenarios/lending/hero-grid/w5-s30/run-config.json --adapter /home/ailton/Work/riptide/riptide/fixtures/adapters/lending.toml
```
