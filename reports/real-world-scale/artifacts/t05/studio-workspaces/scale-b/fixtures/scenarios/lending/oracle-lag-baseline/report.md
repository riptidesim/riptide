...
- **Output**: `fixtures/scenarios/lending/oracle-lag-baseline`
...
```sh
riptide run .riptide/scenarios/lending/oracle-lag-baseline/run-config.json --adapter /home/ailton/Work/riptide/riptide/fixtures/adapters/lending.toml
```
