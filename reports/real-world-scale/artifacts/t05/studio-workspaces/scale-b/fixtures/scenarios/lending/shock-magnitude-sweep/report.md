...
- **Output**: `fixtures/scenarios/lending/shock-magnitude-sweep`
...
```sh
riptide run .riptide/scenarios/lending/shock-magnitude-sweep/run-config.json --adapter /home/ailton/Work/riptide/riptide/fixtures/adapters/lending.toml
```
