...
- **Scenario**: baseline
- **Output**: `/home/ailton/Work/riptide/riptide/fixtures/scenarios/liquid-staking/slash-magnitude-sweep`
...
```sh
exec riptide run fixtures/scenarios/liquid-staking/slash-magnitude-sweep/run-config.json --adapter fixtures/adapters/liquid-staking.toml
```
