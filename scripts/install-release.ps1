...
function Get-Target {
  ...
  switch -Regex ($arch) {
    "^(X64|AMD64)$" {
      Die "Windows release bundles are not currently published for v0.11.0. Use WSL/Linux, macOS, or build from source until riptide-x86_64-pc-windows-msvc.zip is attached to a release."
    }
    default {
